...
// observability tiers — we already skip `provider.register()` so Next.js's
// auto-OTel shouldn't see this provider in the first place, but if something
// ever makes the provider global, the filter keeps the project clean.
