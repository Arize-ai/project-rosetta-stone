# Wonder Toys — Vercel Eve (Phoenix Instrumented)

This is the **Vercel Eve** variant of the Wonder Toys shopping agent, instrumented with Arize Phoenix Cloud for observability.
