...
- **`package.json`** — Adds `@vercel/otel`, `@ai-sdk/otel`, `@opentelemetry/*`, `@arizeai/openinference-vercel` (v3), `@arizeai/openinference-semantic-conventions`.
