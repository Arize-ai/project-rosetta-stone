...
import { initTracing } from "@/beeai/tracing";
...
async function main() {
  ...
  // Give the SimpleSpanProcessor a moment to flush before we exit. With
  // tsx + top-level await + process.exit() the spans can race the OTLP send.
