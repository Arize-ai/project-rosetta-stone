...
// before it reaches the underlying simple-span exporter. Next.js's built-in
// OTel auto-instrumentation otherwise pipes its HTTP / fetch / page-render
// spans through whatever global provider is registered, polluting the
// Phoenix project alongside the agent spans. Same predicate
