...
public class ShoppingAgent {
   ...
   *     non-void value is required by the phoenix/ax tiers' {@code @Agent} annotation — the
   *     OpenInference advice binds {@code @Advice.Return Object} on method exit so a void method
   *     fails to instrument. The shape is the same here for parity across tiers.
   */
  public String chat(
