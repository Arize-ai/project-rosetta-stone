...
# agent-framework packages are pre-release and require the --pre flag
echo "Installing Microsoft Agent Framework packages (pre-release)..."
uv pip install -q --pre agent-framework agent-framework-anthropic
