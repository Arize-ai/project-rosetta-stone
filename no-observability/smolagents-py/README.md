# Wonder Toys — smolagents (No Observability)

This is the smolagents (Hugging Face) variant of the Wonder Toys shopping agent with no observability instrumentation.
