# Wonder Toys — Claude Agent SDK Python (No Observability)

This is the Claude Agent SDK Python variant of the Wonder Toys shopping agent with no observability instrumentation.
